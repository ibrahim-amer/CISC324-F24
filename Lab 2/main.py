...
if __name__ == "__main__":
    ...
    process_sender = multiprocessing.Process(target=process_with_pipe, args=(parent_conn, "Hello from child process!",))
    process_receiver = multiprocessing.Process(target=process_with_pipe_receiver, args=(child_conn,))
